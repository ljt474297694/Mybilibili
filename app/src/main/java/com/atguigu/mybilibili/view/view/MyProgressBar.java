package com.atguigu.mybilibili.view.view;
...
public class MyProgressBar extends View {
    ...
    public MyProgressBar(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            progressWidth = array.getDimension(R.styleable.progress_progressWidth, BitmapUtils.dip2px(8));
            textSize = array.getDimension(R.styleable.progress_textSize, BitmapUtils.dip2px(16));
            array.recycle();
        } else {
            bgColor = Color.GRAY;
            srcColor = Color.RED;
            ...
            sweepArc = 0;
            progressWidth = BitmapUtils.dip2px(8);
            textSize = BitmapUtils.dip2px(16);
        }
